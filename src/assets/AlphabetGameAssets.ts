...
export default ( step: number, langCode: string, low: number ) => {
   ...
   const resource = [
      ...
      { name: 'introTitle2_4', url: `${introImgPath}title2_4.png`},
      { name: 'introTitle2_5', url: `${introImgPath}title2_5.png`},
      { name: 'introTitle2_6', url: `${introImgPath}title2_6.png`},
      { name: 'introTitle2_7', url: `${introImgPath}title2_7.png`},
      { name: 'introTitle2_8', url: `${introImgPath}title2_8.png`},
      { name: 'introTitle2_9', url: `${introImgPath}title2_9.png`},
      { name: 'introTitle2_10', url: `${introImgPath}title2_10.png`},
