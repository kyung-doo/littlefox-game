...
export default ( langCode: string, low: number ) => {
   ...
   const resource = [
      ...
      { name: 'audioBgm', url: `${audioPath}bgm_letterteams.mp3` },
      ...
      { name: 'mainScorePlus150', url: `${mainImgPath}score_plus_150.png`},
      { name: 'mainScorePlus200', url: `${mainImgPath}score_plus_200.png`},
      { name: 'mainScorePlus250', url: `${mainImgPath}score_plus_250.png`},
