import { FC, memo, useEffect, useRef, useMemo, useCallback } from "react";
...
const BonusContainer: FC<_ReactPixi.IContainer> = ( props ) => {
   ...
   const getBonusTextures1 = useMemo(() => {
      return Object.keys(resources.spritesheetBubbleLight1.textures).map( name => resources.spritesheetBubbleLight1.textures[name]);
   }, []);

   const getBonusTextures2 = useMemo(() => {
      return Object.keys(resources.spritesheetBubbleLight2.textures).map( name => resources.spritesheetBubbleLight2.textures[name]);
   }, []);
   ...
   return (
      <Container 
         ...
         <Sprite 
            ...
            visible={bonusCount > 2}
            position={[290, -30]}
            texture={resources.mainBonusEffect.texture} />
      </Container>
   );
}
