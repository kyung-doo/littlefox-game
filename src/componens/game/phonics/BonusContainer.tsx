...
const BonusContainer: FC<_ReactPixi.IContainer> = ( props ) => {
   ...
   const getBonusTextures1 = useMemo(() => {
      return Object.keys(resources.spritesheetArrowLight1.textures).map( name => resources.spritesheetArrowLight1.textures[name]);
   }, []);

   const getBonusTextures2 = useMemo(() => {
      return Object.keys(resources.spritesheetArrowLight2.textures).map( name => resources.spritesheetArrowLight2.textures[name]);
   }, []);
   ...
   return (
      <Container 
         ...
         <Sprite 
            ...
            visible={bonusCount > 2}
            position={[330, -18]}
            texture={resources.mainBonusOnGlow.texture} />
      </Container>
   );
}
